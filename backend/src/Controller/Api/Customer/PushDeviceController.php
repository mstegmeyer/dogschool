...
#[Route('/api/customer/me/push-devices', name: 'api_customer_push_devices_')]
...
final class PushDeviceController extends AbstractController
{
    ...
    public function upsert(
        ...
        $pushDevice = $this->pushDeviceManager->registerForCustomer($customer, $dto);
    ...
    public function unregister(
        ...
        return $this->json([
            'success' => $this->pushDeviceManager->unregisterForCustomer($customer, $dto->token),
        ]);
    }
}
