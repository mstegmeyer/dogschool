    ...
    <UCard v-if="selectedDate">
      ...
      <div class="space-y-3 text-sm">
        ...
        <div v-if="selectedDate.subscribers?.length" class="border-t border-slate-100 pt-3">
          <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">Kurs-Abonnenten</p>
        ...
        <div class="border-t border-slate-100 pt-3">
          <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">Angemeldete Hunde</p>
