      ...
      <table class="w-full text-sm">
        <thead>
          <tr class="border-b border-slate-100 text-left text-xs text-slate-500">
            ...
            <th class="w-[88px] px-2 py-1.5 font-medium">Zeit</th>
            <th class="w-[72px] px-2 py-1.5 font-medium">Stufe</th>
            <th class="w-[100px] px-2 py-1.5 text-right font-medium">Aktion</th>
          </tr>
        </thead>
        <tbody>
          <tr
